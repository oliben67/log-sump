...
from log_sump_common.auth import verify_owner_signature
from log_sump_common.redis_keys import gateway_list_key, gateway_nonce_key, gateway_ownership_key
from redis.asyncio import Redis

logger = structlog.get_logger(__name__)

try:
    GATEWAY_VERSION = importlib.metadata.version("log-sump-server")
