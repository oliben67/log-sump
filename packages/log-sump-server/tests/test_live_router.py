...
is tested directly too, via a hand-built `Request`, for the same reason.
"""
...
from log_sump_server.deps import require_valid_api_key_sse
from log_sump_server.routers.live import sse_generator
